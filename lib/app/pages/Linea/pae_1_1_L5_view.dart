...
class Pae_1_1_L5_View extends StatefulWidget {
  const Pae_1_1_L5_View({
    super.key,
    required this.id,
    required this.list,
    /*this.object*/
  ...
  //id=6;
  @override
  State<Pae_1_1_L5_View> createState() => _Pae_1_1_L5_ViewState();
}

// ignore: camel_case_types
class _Pae_1_1_L5_ViewState extends State<Pae_1_1_L5_View> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Introduzca el quinto parametro que se señaliza con color azul en el codigo de ejemplo:',
              ...
              RichText(
                text: TextSpan(
                  text:
                      '${_Linea_cod5[0][0]}"-${_Linea_cod5[0][1].toUpperCase()}-${_Linea_cod5[0][2].toUpperCase()}-${_Linea_cod5[0][3].toUpperCase()}-',
                  //text: '12"-',
              ...
              BotonPrueba(
                ...
                onTap: () {
                  ...
                  if (_Linea_cod5[1][4] != 'NoEncontrado') {
                    GoRouter.of(context).pushNamed(Routes.pae_1_1_L6,
                          ...
                          TextButton(
                            onPressed: () {
                              GoRouter.of(context).pushNamed(
                                  Routes.pae_1_1_L6, //falta aca error
                                  extra:
                                      _Linea_cod5, //le paso el array a siguinete pagina
                                  params: {
                                    'id': id.toString(),
