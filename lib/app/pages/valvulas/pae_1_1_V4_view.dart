...
class Pae_1_1_V4_View extends StatefulWidget {
  const Pae_1_1_V4_View({
    super.key,
    required this.id,
    required this.list,
    /*this.object*/
  ...
  //id=6;
  @override
  State<Pae_1_1_V4_View> createState() => _Pae_1_1_V4_ViewState();
}

// ignore: camel_case_types
class _Pae_1_1_V4_ViewState extends State<Pae_1_1_V4_View> {
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text(
                  'Introduzca el segundo parametro que esta debajo de la imagen que se señaliza con color azul en el codigo de ejemplo:',
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      height: 60,
                      width: 100,
                      child: Image.asset(_Linea_cod4[1][0]), //imagen
                    ),
                    RichText(
                      text: TextSpan(
                        text: '${_Linea_cod4[0][2]}-',
                        style: const TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            fontWeight: FontWeight.bold),
                ...
                BotonPrueba(
                  ...
                  onTap: () {
                    ...
                    if (_Linea_cod4[1][3] != 'NoEncontrado') {
                      GoRouter.of(context).pushNamed(Routes.pae_1_1_V5,
                            ...
                            TextButton(
                              onPressed: () {
                                GoRouter.of(context).pushNamed(
                                    Routes.pae_1_1_V5, //falta aca error
                                    extra:
                                        _Linea_cod4, //le paso el array a siguinete pagina
                                    params: {
                                      'id': id.toString(),
