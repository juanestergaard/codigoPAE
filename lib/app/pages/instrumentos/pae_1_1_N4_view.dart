...
class Pae_1_1_N4_View extends StatefulWidget {
  const Pae_1_1_N4_View({
    super.key,
    required this.id,
    required this.list,
    /*this.object*/
  ...
  //id=6;
  @override
  State<Pae_1_1_N4_View> createState() => _Pae_1_1_N4_ViewState();
}

// ignore: camel_case_types
class _Pae_1_1_N4_ViewState extends State<Pae_1_1_N4_View> {
...
*/
                    ...
                    Text(
                      'La funcion del instrumento de la imagen es: ${_Linea_cod6[0][0]}',
